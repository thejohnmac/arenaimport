...
//    });
    ...
    $('#toggle').click(function() {
       $(this).toggleClass('active-mobilemenu');
       $('#overlay-mobilemenu').toggleClass('open-mobilemenu');
      });
      
    $('.mobilemenu .btn-nav').click(function() {
       $('#toggle').removeClass('active-mobilemenu');
       $('#overlay-mobilemenu').removeClass('open-mobilemenu');
      });
    ...
    $(document).on('scroll', function() {
      var activeClass = 'mobilemenuwhite',
          ActiveID        = '.mobilemenu',
    ...
    $(document).on('scroll', function() {
          var activeClass = 'main-navbar-white',
    ...
    $(document).on('scroll', function() {
          var activeClass = 'medal-animation',
              ActiveID        = '.quali',
              scrollPos       = $(this).scrollTop();
    ...
    $(document).on('scroll', function() {
          var activeClass = 'quali-animation',
              ActiveID        = '.quali',
              scrollPos       = $(this).scrollTop();
    ...
    $(document).on('scroll', function() {
          var activeClass = 'whatsapp-animation',
              ActiveID        = '.features-section-6',
              scrollPos       = $(this).scrollTop();
...
//              offsetTop = $this.offset().top;
//          if (scrolled + win_height_padded < offsetTop) {
//            $(this).removeClass('animated fadeInDown fadeIn slideInDown flipInX lightSpeedIn')
//          }
//        });
//      }
//    
